...
std::string LicenseInfo()
{
    ...
    const std::string URL_SOURCE_CODE = "<https://github.com/VaporumCoin/VaporumQT-Wallet>";
    ...
    return "\n" +
		   ...
		   FormatParagraph(strprintf(_("Copyright (C) 2022-%i Vaporum Coin developers"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
