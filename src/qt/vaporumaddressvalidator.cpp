...
VaporumAddressEntryValidator::VaporumAddressEntryValidator(QObject *parent, bool allowZAddresses) :
    QValidator(parent),
    _allowZAddresses(allowZAddresses)
{
}

QValidator::State VaporumAddressEntryValidator::validate(QString &input, int &pos) const
{
    Q_UNUSED(pos);
...
VaporumAddressCheckValidator::VaporumAddressCheckValidator(QObject *parent, bool allowZAddresses) :
    QValidator(parent),
    _allowZAddresses(allowZAddresses)
{
}

QValidator::State VaporumAddressCheckValidator::validate(QString &input, int &pos) const
{
    Q_UNUSED(pos);
    // Validate the passed Vaporum address
    if (_allowZAddresses) {
