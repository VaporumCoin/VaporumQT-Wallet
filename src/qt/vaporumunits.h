...
#ifndef VAPORUM_QT_VAPORUMUNITS_H
#define VAPORUM_QT_VAPORUMUNITS_H
...
/** Vaporum unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class VaporumUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit VaporumUnits(QObject *parent);

    /** Vaporum units.
      @note Source: https://en.vaporum.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        KMD,
...
typedef VaporumUnits::Unit VaporumUnit;

#endif // VAPORUM_QT_VAPORUMUNITS_H
