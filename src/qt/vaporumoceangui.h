...
/**
  Vaporum GUI main class. This class represents the main window of the Vaporum UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class VaporumOceanGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit VaporumOceanGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~VaporumOceanGUI();
