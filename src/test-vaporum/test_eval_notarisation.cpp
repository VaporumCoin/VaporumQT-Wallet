...
extern int32_t vaporum_notaries(uint8_t pubkeys[64][33],int32_t height,uint32_t timestamp);
...
namespace TestEvalNotarisation {
    ...
    template<typename Modifier>
        ...
        {
            eval.nNotaries = vaporum_notaries(eval.notaries, 780060, 1522946781);
