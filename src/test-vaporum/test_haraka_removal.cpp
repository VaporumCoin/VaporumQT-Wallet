...
// ./vaporum-test --gtest_filter=TestHarakaRemoval.*
    ...
    TEST(TestHarakaRemoval, test_block_prg) {
        ...
        */
        ...
        for (size_t i = 0; i < sizeof(blockHeights)/sizeof(blockHeights[0]); i++) {
            ...
            EXPECT_EQ(vaporum_block_prg(blockHeights[i]), prgs_before[i]);
            EXPECT_EQ(vaporum_block_unlocktime(blockHeights[i]), unlocktimes_before[i]);
        ...
        */
        for (size_t i = 0; i < sizeof(blockHeights)/sizeof(blockHeights[0]); i++) {
            ...
            EXPECT_EQ(vaporum_block_prg(blockHeights[i]), prgs_after[i]);
            EXPECT_EQ(vaporum_block_unlocktime(blockHeights[i]), unlocktimes_after[i]);
