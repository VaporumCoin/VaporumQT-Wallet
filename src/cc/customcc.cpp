/*
 ...
 Just update the functions in this file, then from ~/vaporum/src/cc
 
 ../vaporum-cli -ac_name=CUSTOM stop
 ./makecustom
 ../vaporumd -ac_name=CUSTOM -ac_cclib=custom -ac_cc=2 ...
 
 The above will rebuild vaporumd and get it running again
 */
...
{
    CMutableTransaction mtx = CreateNewContextualCMutableTransaction(Params().GetConsensus(), vaporum_nextheight()); std::string rawtx;
