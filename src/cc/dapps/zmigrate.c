...
cJSON *get_vaporumcli(char *refcoin,char **retstrp,char *acname,char *method,char *arg0,char *arg1,char *arg2,char *arg3)
{
...
bits256 vaporumbroadcast(char *refcoin,char *acname,cJSON *hexjson)
{
    char *hexstr,*retstr,str[65]; cJSON *retjson; bits256 txid;
    memset(txid.bytes,0,sizeof(txid));
    if ( (hexstr= jstr(hexjson,"hex")) != 0 )
    {
        if ( (retjson= get_vaporumcli(refcoin,&retstr,acname,"sendrawtransaction",hexstr,"","","")) != 0 )
        {
...
bits256 sendtoaddress(char *refcoin,char *acname,char *destaddr,int64_t satoshis)
{
    ...
    if ( (retjson= get_vaporumcli(refcoin,&retstr,acname,"sendtoaddress",destaddr,numstr,"","")) != 0 )
    {
...
int32_t get_coinheight(char *refcoin,char *acname)
{
    ...
    if ( (retjson= get_vaporumcli(refcoin,&retstr,acname,"getblockchaininfo","","","","")) != 0 )
    {
...
bits256 get_coinblockhash(char *refcoin,char *acname,int32_t height)
{
    ...
    if ( (retjson= get_vaporumcli(refcoin,&retstr,acname,"getblockhash",heightstr,"","","")) != 0 )
    {
...
bits256 get_coinmerkleroot(char *refcoin,char *acname,bits256 blockhash)
{
    ...
    if ( (retjson= get_vaporumcli(refcoin,&retstr,acname,"getblockheader",bits256_str(str,blockhash),"","","")) != 0 )
    {
...
cJSON *get_rawmempool(char *refcoin,char *acname)
{
    ...
    if ( (retjson= get_vaporumcli(refcoin,&retstr,acname,"getrawmempool","","","","")) != 0 )
    {
        //printf("mempool.(%s)\n",jprint(retjson,0));
        return(retjson);
    }
...
cJSON *get_addressutxos(char *refcoin,char *acname,char *coinaddr)
{
    ...
    if ( (retjson= get_vaporumcli(refcoin,&retstr,acname,"getaddressutxos",jsonbuf,"","","")) != 0 )
    {
...
cJSON *get_rawtransaction(char *refcoin,char *acname,bits256 txid)
{
    ...
    if ( (retjson= get_vaporumcli(refcoin,&retstr,acname,"getrawtransaction",bits256_str(str,txid),"1","","")) != 0 )
    {
        return(retjson);
    }
    else if ( retstr != 0 )
...
{
    cJSON *retjson; char *retstr,str[65];
    if ( (retjson= get_vaporumcli(refcoin,&retstr,acname,"listunspent","","","","")) != 0 )
    {
        return(retjson);
    }
    else if ( retstr != 0 )
...
{
    cJSON *retjson; char *retstr,str[65];
    if ( (retjson= get_vaporumcli(refcoin,&retstr,acname,"z_listunspent","","","","")) != 0 )
    {
        return(retjson);
    }
    else if ( retstr != 0 )
...
{
    cJSON *retjson; char *retstr,str[65];
    if ( (retjson= get_vaporumcli(refcoin,&retstr,acname,"z_listoperationids","","","","")) != 0 )
    {
        return(retjson);
    }
    else if ( retstr != 0 )
...
cJSON *z_getoperationstatus(char *refcoin,char *acname,char *opid)
{
    ...
    if ( (retjson= get_vaporumcli(refcoin,&retstr,acname,"z_getoperationstatus",params,"","","")) != 0 )
    {
        //printf("got status (%s)\n",jprint(retjson,0));
        return(retjson);
    }
...
cJSON *z_getoperationresult(char *refcoin,char *acname,char *opid)
{
    cJSON *retjson; char *retstr,str[65],params[512];
    sprintf(params,"'[\"%s\"]'",opid);
    if ( (retjson= get_vaporumcli(refcoin,&retstr,acname,"z_getoperationresult",params,"","","")) != 0 )
    {
        return(retjson);
    }
    else if ( retstr != 0 )
...
int32_t validateaddress(char *refcoin,char *acname,char *depositaddr, char* compare)
{
    ...
    if ( (retjson= get_vaporumcli(refcoin,&retstr,acname,"validateaddress",depositaddr,"","","")) != 0 )
    {
...
{
    cJSON *retjson; char *retstr; int32_t res=0;
    if ( (retjson= get_vaporumcli(refcoin,&retstr,acname,"z_validateaddress",depositaddr,"","","")) != 0 )
    {
...
int64_t z_getbalance(char *refcoin,char *acname,char *coinaddr)
{
    ...
    if ( (retjson= get_vaporumcli(refcoin,&retstr,acname,"z_getbalance",coinaddr,"","","")) != 0 )
    {
...
int32_t z_exportkey(char *privkey,char *refcoin,char *acname,char *zaddr)
{
    cJSON *retjson; char *retstr,cmpstr[64]; int64_t amount=0;
    privkey[0] = 0;
    if ( (retjson= get_vaporumcli(refcoin,&retstr,acname,"z_exportkey",zaddr,"","","")) != 0 )
    {
...
int32_t getnewaddress(char *coinaddr,char *refcoin,char *acname)
{
    ...
    if ( (retjson= get_vaporumcli(refcoin,&retstr,acname,"getnewaddress","","","","")) != 0 )
    {
...
{
    cJSON *retjson; char *retstr; int64_t amount=0; int32_t retval = -1;
    if ( (retjson= get_vaporumcli(refcoin,&retstr,acname,"z_getnewaddress",typestr,"","","")) != 0 )
    {
...
{
    cJSON *retjson; char *retstr;
    if ( (retjson= get_vaporumcli(refcoin,&retstr,acname,"importaddress",depositaddr,"","true","")) != 0 )
    {
...
int32_t z_sendmany(char *opidstr,char *coinstr,char *acname,char *srcaddr,char *destaddr,int64_t amount)
{
    ...
    if ( (retjson= get_vaporumcli(coinstr,&retstr,acname,"z_sendmany",addr,params,"","")) != 0 )
    {
...
int32_t z_mergetoaddress(char *opidstr,char *coinstr,char *acname,char *destaddr)
{
    ...
    if ( (retjson= get_vaporumcli(coinstr,&retstr,acname,"z_mergetoaddress",addr,destaddr,"","")) != 0 )
    {
...
int32_t itemvalid(char *refcoin,int64_t *refundedp,int64_t *waitingp,struct claimitem *item)
{
    ...
    *refundedp = *waitingp = 0;
    ...
    sprintf(url,"https://kmd.explorer.dexstats.info/insight-api-vaporum/addr/%s",item->destaddr);
...
int32_t main(int32_t argc,char **argv)
{
    ...
    {
        sprintf(buf,"./vaporum-cli -ac_name=%s",argv[1]);
