...
int32_t vaporum_dpowconfs(int32_t height,int32_t numconfs);
int8_t vaporum_segid(int32_t nocache,int32_t height);
int32_t vaporum_nextheight();
int32_t vaporum_notarized_bracket(struct notarized_checkpoint *nps[2],int32_t height);
arith_uint256 vaporum_adaptivepow_target(int32_t height,arith_uint256 bnTarget,uint32_t nTime);
