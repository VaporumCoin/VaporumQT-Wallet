...
uint64_t vaporum_accrued_interest(int32_t *txheightp,uint32_t *locktimep,uint256 hash,int32_t n,int32_t checkheight,uint64_t checkvalue,int32_t tipheight)
{
    return(0);
}
...
// function stub to allow build vaporum-tx
