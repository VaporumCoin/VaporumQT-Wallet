...
# Input
DEPENDPATH += .
HEADERS += src\vaporum_globals.h \
     src\qt\vaporumoceangui.h \
     ...
     src\qt\vaporumaddressvalidator.h \
     ...
     src\streams.h \
     src\vaporum_bitcoind.h \
     src\vaporum_utils.h \
     src\vaporum_notary.h \
     src\vaporum_gateway.h
...
SOURCES += src\protobuf\google\protobuf\any.cc \
    ...
    src\qt\intro.cpp \
    src\qt\vaporum.cpp \
    src\qt\vaporumaddressvalidator.cpp \
    src\qt\vaporumamountfield.cpp \
    src\qt\vaporumoceangui.cpp \
    src\qt\vaporumunits.cpp \
...
# also add new translations to vaporum.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/vaporum_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md src/qt/res/vaporum-qt-res.rc
...
windows:RC_FILE = src/qt/res/vaporum-qt-res.rc
...
macx:ICON = src/qt/res/icons/vaporum.icns
macx:TARGET = "VaporumOceanGUI"
